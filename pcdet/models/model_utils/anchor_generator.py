...
from pcdet.layers import ShapeSpec
from pcdet.structures import Boxes, RotatedBoxes
...
def build_anchor_generator(cfg, input_shape):
    """
    Built an anchor generator from `cfg.ANCHOR_GENERATOR.NAME`.
    """

    anchor_generator = cfg.ANCHOR_GENERATOR.NAME
    return ANCHOR_GENERATOR_REGISTRY.get(anchor_generator)(
        cfg.ANCHOR_GENERATOR, input_shape
    )
