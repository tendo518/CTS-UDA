    ...
    for j, curcls in enumerate(current_classes):
        ...
        for i in range(min_overlaps.shape[0]):
            ...
            if compute_aos:
                ...
                ret_dict[
                    "%s_aos/easy_R40_%.1f_%d"
                    % (class_to_name[curcls], min_overlaps[i, 0, 0], i)
                ] = mAPaos_R40[j, 0, i]
                ret_dict[
                    "%s_aos/moderate_R40_%.1f_%d"
                    % (class_to_name[curcls], min_overlaps[i, 1, 0], i)
                ] = mAPaos_R40[j, 1, i]
                ret_dict[
                    "%s_aos/hard_R40_%.1f_%d"
                    % (class_to_name[curcls], min_overlaps[i, 2, 0], i)
                ] = mAPaos_R40[j, 2, i]
            ...
            ret_dict[
                "%s_3d/easy_R40_%.1f_%d"
                % (class_to_name[curcls], min_overlaps[i, 0, 0], i)
            ] = mAP3d_R40[j, 0, i]
            ret_dict[
                "%s_3d/moderate_R40_%.1f_%d"
                % (class_to_name[curcls], min_overlaps[i, 1, 0], i)
            ] = mAP3d_R40[j, 1, i]
            ret_dict[
                "%s_3d/hard_R40_%.1f_%d"
                % (class_to_name[curcls], min_overlaps[i, 2, 0], i)
            ] = mAP3d_R40[j, 2, i]
            ret_dict[
                "%s_bev/easy_R40_%.1f_%d"
                % (class_to_name[curcls], min_overlaps[i, 0, 0], i)
            ] = mAPbev_R40[j, 0, i]
            ret_dict[
                "%s_bev/moderate_R40_%.1f_%d"
                % (class_to_name[curcls], min_overlaps[i, 1, 0], i)
            ] = mAPbev_R40[j, 1, i]
            ret_dict[
                "%s_bev/hard_R40_%.1f_%d"
                % (class_to_name[curcls], min_overlaps[i, 2, 0], i)
            ] = mAPbev_R40[j, 2, i]
            ret_dict[
                "%s_image/easy_R40_%.1f_  %d"
                % (class_to_name[curcls], min_overlaps[i, 0, 0], i)
            ] = mAPbbox_R40[j, 0, i]
            ret_dict[
                "%s_image/moderate_R40_%.1f_%d"
                % (class_to_name[curcls], min_overlaps[i, 1, 0], i)
            ] = mAPbbox_R40[j, 1, i]
            ret_dict[
                "%s_image/hard_R40_%.1f_%d"
                % (class_to_name[curcls], min_overlaps[i, 2, 0], i)
            ] = mAPbbox_R40[j, 2, i]
