...
# TODO convert calib to torch_calib
class TorchCalibration(object):
    def __init__(self, calib: Calibration):
        pass

        self.P2 = torch.from_numpy(calib.P2)  # 3 x 4
        self.R0 = torch.from_numpy(calib.R0)  # 3 x 3
        self.V2C = torch.from_numpy(calib.V2C)  # 3 x 4
